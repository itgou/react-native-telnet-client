...
class Telnet extends events.EventEmitter {
  ...
  connect(opts) {
    ...
    return (promise = new Promise((resolve, reject) => {
      ...
      const localAddress =
        typeof opts.localAddress !== 'undefined' ? opts.localAddress : '';
      const socketConnectOptions =
        typeof opts.socketConnectOptions !== 'undefined'
          ? opts.socketConnectOptions
          : {};
      ...
      this.negotiationMandatory =
        typeof opts.negotiationMandatory !== 'undefined'
          ...
          : true;
      this.initialLFCR =
        typeof opts.initialLFCR !== 'undefined' ? opts.initialLFCR : false;
      this.initialCTRLC =
        typeof opts.initialCTRLC !== 'undefined' ? opts.initialCTRLC : false;
      this.execTimeout =
        typeof opts.execTimeout !== 'undefined' ? opts.execTimeout : 2000;
      this.sendTimeout =
        typeof opts.sendTimeout !== 'undefined' ? opts.sendTimeout : 2000;
